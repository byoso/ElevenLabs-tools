...
characters = [
    {"name": "James", "voice_id": "EkK5I93UQWFDigLMpZcX","dialog": {
        "title": "try",
        "text": "Let's try !"
    }},
    {"name": "Arabella", "voice_id": "Z3R5wn05IrDiVCyEkUrK","dialog": {
        "title": "try",
        "text": "Let's try !"
    }},
    {"name": "Blondie", "voice_id": "exsUS4vynmxd379XN4yO","dialog": {
        "title": "try",
        "text": "Let's try !"
    }},
    {"name": "Kuon", "voice_id": "B8gJV1IhpuegLxdpXFOE","dialog": {
        "title": "try",
        "text": "Let's try !"
    }},
]
...
def convert_text_to_speech(char):
    ...
    if DEBUG:
        file_path = f"debug-{char['name']}.txt"
        with open(file_path, "wb") as f:
            f.write(json.dumps(char["dialog"]).encode())
